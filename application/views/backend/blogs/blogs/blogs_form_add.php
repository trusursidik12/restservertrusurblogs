            ...
            <form role="form" action="<?= site_url('backoffice/'.$controllers.'/add') ?>" method="post" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  <input type="Text" name="blg_title" class="form-control <?= form_error('blg_title') == TRUE ? 'is-invalid' : ''; ?>" placeholder="Input Blog Title *">
                ...
                <div class="form-group">
                  <input type="Text" name="blg_video" class="form-control" placeholder="Input Link Video Youtube">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="Text" name="blg_tags[]" class="form-control <?= form_error('blg_tags[]') == TRUE ? 'is-invalid' : ''; ?>" data-role="tagsinput" placeholder="Tags (separated with ' , ') *">
